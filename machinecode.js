...
function fromMachineC(A) {
	var $ = /[01_$A-D][\x00-\x0601]/g
	var _ = {
    "0": "a", "1": "b", "0\x02": "c", "0\x03": "d", "0\x04": "e", "0\x05": "f", "0\x06": "g", "1\x02": "h", "1\x03": "i", "1\x04": "j", "1\x05": "k", "1\x06": "l", "0\t": "m", "1\t": "n", "0\n": "o", "1\n": "p", "1A": "0A", "0B": "r", "1B": "s", "0C": "t", "1C": "u", "0D": "v", "1D": "w", "0E": "x", "1E": "y", "0F": "z", "_\x00": " ", "A\x00": "A", "A\x01": "B", "A\x02": "C", "A\x03": "E", "A\x04": "F", "A\x05": "G", "A\x06": "H", "B\x00": "I", "B\x01": "J", "B\x02": "K", "B\x03": "M", "B\x04": "N", "B\x05": "O", "B\x06": "P", "C\x00": "Q", "C\x01": "R", "C\x02": "S", "C\x03": "U", "C\x04": "V", "C\x05": "W", "C\x06": "X", "D\x00": "Y", "D\x01": "Z", "_\x01": "-", "_\x02": "_", "_\x03": "'", "_\x04": '"', "_\x05": "+", "_\x06": "*", "$\x00": "/", "$\x01": "!", "$\x02": "@", "$\x03": "#", "$\x04": "$", "\x07": ""
	}
